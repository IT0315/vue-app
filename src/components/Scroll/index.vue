  ...
  <div ref="scroll" :class="c()">
    ...
    <div :class="c('wrapper')">
      ...
      <slot
        ...
        name="pullup"
      >
        <div v-if="pullUp" :class="c('pullup')">
          <div v-if="!pullUpNow">
            <span>{{ pullUpTxt }}</span>
          </div>
          <div v-else>
    ...
    <slot
      ...
      name="pulldown"
    >
      <div v-if="pullDown" ref="pulldown" :style="pullDownStyle" :class="c('pulldown')">
        <div v-if="pullDownBefore" :class="c('pulldown__before')">
          <Bubble :y="bubbleY"/>
        </div>
        <div v-else :class="c('pulldown__after')">
...
<style lang="stylus">
@import '../common/stylus/import.styl';
